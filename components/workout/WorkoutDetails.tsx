        ...
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <button
              ...
              disabled={isPlanFull}
              className="inline-flex items-center gap-2 rounded-md bg-[#ccff00] px-5 py-3 text-sm font-bold text-black transition-transform hover:scale-[1.02] disabled:opacity-50 disabled:hover:scale-100"
            >
              <CalendarEvent />
